...
export const POST = async (req: MedusaRequest, res: MedusaResponse) => {
    console.log('POST method at fileUpload');
    ...
    try {
        ...
        // Prepare responses for each uploaded file (image or audio)
        const response = {
            done: "ok",
        ...
        // Process image and audio fields dynamically
        ...
        for (const field of allFileFields) {
            ...
            // Initialize an array to store multiple file URLs (images or audio) for this field
            response.files[field] = [];

            // Process each file (image or audio) in the array
