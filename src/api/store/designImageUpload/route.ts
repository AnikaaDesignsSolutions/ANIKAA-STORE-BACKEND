...
const readFile = (req: MedusaRequest, saveLocally?: boolean): Promise<{ fields: formidable.Fields; files: formidable.Files }> => {
    ...
    if (saveLocally) {
        ...
        options.uploadDir = path.resolve("C://Users//Roshini//Downloads//ANIKAA//anikaa_backend//uploads");
...
export const POST = async (req: MedusaRequest, res: MedusaResponse) => {
    ...
    const mediaDir = path.resolve("C://Users//Roshini//Downloads//ANIKAA//anikaa_backend//uploads");
